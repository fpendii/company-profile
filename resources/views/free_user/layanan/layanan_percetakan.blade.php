                ...
                <div class="row">
                    <section id="projects">
                        <article>
                            ...
                            <div class="span6">
                                <div class="post-slider">
                                    <div class="post-heading">
                                        <h3><a href="layanan">{{ $layananPercetakan->nama_layanan }}</a></h3>
                                    </div>
                            ...
                            <div class="span6">
                                <div class="post-heading">
                                    <h3>Kategori {{ $layananPercetakan->nama_layanan }}</h3>
                                </div>

                                @foreach ($layananPercetakan->kategoriLayanan as $kategori)
