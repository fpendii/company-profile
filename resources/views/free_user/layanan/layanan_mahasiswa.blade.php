            ...
            <div class="row">
                <div class="span12">
                    <ul class="portfolio-categ">
                        <li class="{{ Request::is('layanan') ? 'active' : '' }}"><a href="/layanan">Bimbingan Mahasiswa</a>
                        </li>
                        <li class="{{ Request::is('layanan/bimbingan-umum') ? 'active' : '' }}"><a
                                href="/layanan/bimbingan-umum">Bimbingan Umum</a></li>
                        <li class="{{ Request::is('layanan/artikel-ilmiah') ? 'active' : '' }}"><a
                                href="/layanan/artikel-ilmiah">Artikel Ilmiah</a></li>
                        <li class="{{ Request::is('layanan/olah-data') ? 'active' : '' }}"><a href="/layanan/olah-data">Olah
                                Data</a></li>
                        <li class="{{ Request::is('layanan/percetakan') ? 'active' : '' }}"><a
                                href="/layanan/percetakan">Percetakan</a></li>
                    </ul>
                    ...
                    <div class="row">
                        <section id="projects">
                            <article>
                                ...
                                <div class="span6">
                                    <div class="post-slider">
                                        <div class="post-heading">
                                            <h3><a href="layanan">{{ $layananBimbinganMahasiswa->nama_layanan }}</a></h3>
                                        </div>
                                        ...
                                        <div class="bottom-article">
                                            {{ $layananBimbinganMahasiswa->penjelasan }}
                                            {{-- <p>
                                ...
                                <div class="span6">
                                    <div class="post-heading">
                                        <h3>Kategori {{ $layananBimbinganMahasiswa->nama_layanan }}</h3>
                                    </div>

                                    @foreach ($layananBimbinganMahasiswa->kategoriLayanan as $kategori)
