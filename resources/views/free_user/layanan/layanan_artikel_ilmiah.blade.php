                ...
                <div class="row">
                    <section id="projects">
                        <article>
                            ...
                            <div class="span6">
                                <div class="post-slider">
                                    <div class="post-heading">
                                        <h3><a href="layanan">{{ $layananArtikelIlmiah->nama_layanan }}</a></h3>
                                    </div>
                                    ...
                                    <div class="bottom-article">
                                        {{ $layananArtikelIlmiah->penjelasan }}
                                        {{-- <p>
                            ...
                            <div class="span6">
                                <div class="post-heading">
                                    <h3>Kategori {{ $layananArtikelIlmiah->nama_layanan }}</h3>
                                </div>

                                @foreach ($layananArtikelIlmiah->kategoriLayanan as $kategori)
